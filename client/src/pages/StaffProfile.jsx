...
export default function StaffProfile() {
  ...
  const save = async () => {
    ...
    localStorage.setItem(
      "user",
      JSON.stringify({ id: u._id, name: u.name, email: u.email })
    );
  ...
  const onPhoto = async (e) => {
    ...
    const res = await axios.post(
      `http://localhost:5000/api/auth/profile/${id}/photo`,
      fd
    );
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 ml-64">
        ...
        <div className="p-6">
          {/* Header Banner */}
          <div className="bg-blue-400 text-white p-5 rounded-xl mb-6">
            <p className="text-sm">Profile</p>
            <h2 className="text-2xl font-semibold">
              Manage account information, preferences, and security
            </h2>
          </div>
